...
DTYPES = (DICHOTOMOUS, DICHOTOMOUS_CANCER, CONTINUOUS, CONTINUOUS_INDIVIDUAL, NESTED_DICHOTOMOUS, MULTI_TUMOR)
DICHOTOMOUS_DTYPES = (DICHOTOMOUS, DICHOTOMOUS_CANCER, MULTI_TUMOR)
