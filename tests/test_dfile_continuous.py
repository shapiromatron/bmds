...
def test_Polynomial_216(dataset):
    model = bmds.Polynomial_216(dataset)
    dfile = model.as_dfile()
    expected = 'Polynomial\nBMDS_Model_Run\n/temp/bmd/datafile.dax\n/temp/bmd/output.out\n2\n1 5 0\n250 1e-08 1e-08 0 0 1 0 0\n1 1.0 1 0.95\n-9999 0 -9999 -9999 -9999\n0\n-9999 -9999 -9999 -9999 -9999\nDose NumAnimals Response Stdev\n0.000000 111.000000 2.112000 0.235000\n10.000000 142.000000 2.095000 0.209000\n50.000000 143.000000 1.956000 0.231000\n150.000000 93.000000 1.587000 0.263000\n400.000000 42.000000 1.254000 0.159000'  # noqa
    assert dfile == expected


def test_Polynomial_217(dataset):
    model = bmds.Polynomial_217(dataset)
    dfile = model.as_dfile()
    expected = ''
...
def test_Exponential_M2_17(dataset):
    model = bmds.Exponential_M2_17(dataset)
    dfile = model.as_dfile()
...
def test_Exponential_M2_19(dataset):
    model = bmds.Exponential_M2_19(dataset)
    dfile = model.as_dfile()
...
def test_Exponential_M3_17(dataset):
    model = bmds.Exponential_M3_17(dataset)
    dfile = model.as_dfile()
    expected = 'Exponential\nBMDS_Model_Run\n/temp/bmd/datafile.dax\n/temp/bmd/output.out\n1 5 0 0100 22 0 1\n250 1e-08 1e-08 0 1 0 0\n1 1.0 1 0.95\n-9999 0 -9999 -9999 -9999 -9999\n0\n-9999 -9999 -9999 -9999 -9999 -9999\n-9999 0 -9999 -9999 -9999 -9999\n0\n-9999 -9999 -9999 -9999 -9999 -9999\n-9999 0 -9999 -9999 -9999 -9999\n0\n-9999 -9999 -9999 -9999 -9999 -9999\n-9999 0 -9999 -9999 -9999 -9999\n0\n-9999 -9999 -9999 -9999 -9999 -9999\nDose NumAnimals Response Stdev\n0.000000 111.000000 2.112000 0.235000\n10.000000 142.000000 2.095000 0.209000\n50.000000 143.000000 1.956000 0.231000\n150.000000 93.000000 1.587000 0.263000\n400.000000 42.000000 1.254000 0.159000'  # noqa
    assert dfile == expected
...
def test_Exponential_M3_19(dataset):
    model = bmds.Exponential_M3_19(dataset)
    dfile = model.as_dfile()
    expected = 'Exponential\nBMDS_Model_Run\n/temp/bmd/datafile.dax\n/temp/bmd/output.out\n1 5 0 0100 22 0 1\n500 1e-08 1e-08 0 1 0 0\n1 1.0 1 0.95\n-9999 0 -9999 -9999 -9999 -9999\n0\n-9999 -9999 -9999 -9999 -9999 -9999\n-9999 0 -9999 -9999 -9999 -9999\n0\n-9999 -9999 -9999 -9999 -9999 -9999\n-9999 0 -9999 -9999 -9999 -9999\n0\n-9999 -9999 -9999 -9999 -9999 -9999\n-9999 0 -9999 -9999 -9999 -9999\n0\n-9999 -9999 -9999 -9999 -9999 -9999\nDose NumAnimals Response Stdev\n0.000000 111.000000 2.112000 0.235000\n10.000000 142.000000 2.095000 0.209000\n50.000000 143.000000 1.956000 0.231000\n150.000000 93.000000 1.587000 0.263000\n400.000000 42.000000 1.254000 0.159000'  # noqa
    assert dfile == expected
...
def test_Exponential_M4_17(dataset):
    model = bmds.Exponential_M4_17(dataset)
    dfile = model.as_dfile()
    expected = 'Exponential\nBMDS_Model_Run\n/temp/bmd/datafile.dax\n/temp/bmd/output.out\n1 5 0 0010 33 0 1\n250 1e-08 1e-08 0 1 0 0\n1 1.0 1 0.95\n-9999 0 -9999 -9999 -9999 -9999\n0\n-9999 -9999 -9999 -9999 -9999 -9999\n-9999 0 -9999 -9999 -9999 -9999\n0\n-9999 -9999 -9999 -9999 -9999 -9999\n-9999 0 -9999 -9999 -9999 -9999\n0\n-9999 -9999 -9999 -9999 -9999 -9999\n-9999 0 -9999 -9999 -9999 -9999\n0\n-9999 -9999 -9999 -9999 -9999 -9999\nDose NumAnimals Response Stdev\n0.000000 111.000000 2.112000 0.235000\n10.000000 142.000000 2.095000 0.209000\n50.000000 143.000000 1.956000 0.231000\n150.000000 93.000000 1.587000 0.263000\n400.000000 42.000000 1.254000 0.159000'  # noqa
    assert dfile == expected
...
def test_Exponential_M4_19(dataset):
    model = bmds.Exponential_M4_19(dataset)
    dfile = model.as_dfile()
    expected = 'Exponential\nBMDS_Model_Run\n/temp/bmd/datafile.dax\n/temp/bmd/output.out\n1 5 0 0010 33 0 1\n500 1e-08 1e-08 0 1 0 0\n1 1.0 1 0.95\n-9999 0 -9999 -9999 -9999 -9999\n0\n-9999 -9999 -9999 -9999 -9999 -9999\n-9999 0 -9999 -9999 -9999 -9999\n0\n-9999 -9999 -9999 -9999 -9999 -9999\n-9999 0 -9999 -9999 -9999 -9999\n0\n-9999 -9999 -9999 -9999 -9999 -9999\n-9999 0 -9999 -9999 -9999 -9999\n0\n-9999 -9999 -9999 -9999 -9999 -9999\nDose NumAnimals Response Stdev\n0.000000 111.000000 2.112000 0.235000\n10.000000 142.000000 2.095000 0.209000\n50.000000 143.000000 1.956000 0.231000\n150.000000 93.000000 1.587000 0.263000\n400.000000 42.000000 1.254000 0.159000'  # noqa
    assert dfile == expected
...
def test_Exponential_M5_17(dataset):
    model = bmds.Exponential_M5_17(dataset)
    dfile = model.as_dfile()
    expected = 'Exponential\nBMDS_Model_Run\n/temp/bmd/datafile.dax\n/temp/bmd/output.out\n1 5 0 0001 44 0 1\n250 1e-08 1e-08 0 1 0 0\n1 1.0 1 0.95\n-9999 0 -9999 -9999 -9999 -9999\n0\n-9999 -9999 -9999 -9999 -9999 -9999\n-9999 0 -9999 -9999 -9999 -9999\n0\n-9999 -9999 -9999 -9999 -9999 -9999\n-9999 0 -9999 -9999 -9999 -9999\n0\n-9999 -9999 -9999 -9999 -9999 -9999\n-9999 0 -9999 -9999 -9999 -9999\n0\n-9999 -9999 -9999 -9999 -9999 -9999\nDose NumAnimals Response Stdev\n0.000000 111.000000 2.112000 0.235000\n10.000000 142.000000 2.095000 0.209000\n50.000000 143.000000 1.956000 0.231000\n150.000000 93.000000 1.587000 0.263000\n400.000000 42.000000 1.254000 0.159000'  # noqa
    assert dfile == expected
...
def test_Exponential_M5_19(dataset):
    model = bmds.Exponential_M5_19(dataset)
    dfile = model.as_dfile()
    expected = 'Exponential\nBMDS_Model_Run\n/temp/bmd/datafile.dax\n/temp/bmd/output.out\n1 5 0 0001 44 0 1\n500 1e-08 1e-08 0 1 0 0\n1 1.0 1 0.95\n-9999 0 -9999 -9999 -9999 -9999\n0\n-9999 -9999 -9999 -9999 -9999 -9999\n-9999 0 -9999 -9999 -9999 -9999\n0\n-9999 -9999 -9999 -9999 -9999 -9999\n-9999 0 -9999 -9999 -9999 -9999\n0\n-9999 -9999 -9999 -9999 -9999 -9999\n-9999 0 -9999 -9999 -9999 -9999\n0\n-9999 -9999 -9999 -9999 -9999 -9999\nDose NumAnimals Response Stdev\n0.000000 111.000000 2.112000 0.235000\n10.000000 142.000000 2.095000 0.209000\n50.000000 143.000000 1.956000 0.231000\n150.000000 93.000000 1.587000 0.263000\n400.000000 42.000000 1.254000 0.159000'  # noqa
    assert dfile == expected
